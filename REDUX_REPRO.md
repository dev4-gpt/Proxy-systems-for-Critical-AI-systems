...
2. Open and run **`proxytool_REDUX_4_REPRO.ipynb`** top to bottom (5 cells).
...
| | `proxytool_REDUX_4.ipynb` | `proxytool_REDUX_4_REPRO.ipynb` |
|---|---------------------------|----------------------------------|
| Cells | 168 | 5 |
...
Extracted source: `proxytool_redux/_extracted/redux4_core.py`

Orchestration: `proxytool_redux/benchmark.py` → `run_all_benchmarks()`
