...
| **Completed** | **4** |
| **Remaining** | **56** |
| Baseline (pre-grid) | `penalty100_min700_cap21` |
| **Current winner** | `penalty300_min700_cap22_queryv2` |
...
**Pipeline defaults** are in `metamatch_hyperparams.json` (penalty 300, min 700, cap 2/2). See `WINNER.md` for the full comparison table.
...
```bash
bash runs/experiments/scripts/run_targeted_batch3_tmux.sh
