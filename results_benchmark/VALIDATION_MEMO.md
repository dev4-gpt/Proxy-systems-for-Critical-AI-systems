...
## 2 — Testing / QA / security outcomes

**Problem/Question asked:** Similarity must connect to test-relevant outcomes, not retrieval metrics alone.
...
## 3 — Statistics and method positioning
